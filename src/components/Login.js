            ...
            <section class="main-container">
                ...
                <div class="form-container">
                    <div class=" rounded-[16px] p-[40px] gap-[16px] bg-[#FBFBFB] shadow-[0_1px_3px_0px_rgba(0,0,0,0.08)]">
                        ...
                        <form action="#">
                            ...
                            {/*Email Input  */}
                            <div className={`common-container pt-[12px] pb-0 px-[16px]`}>
                            ...
                            <div>{errorMessage && <p className='error-msg font-inter mt-[-16px]'>Email doesn’t exist</p>}</div>
                            ...
                            <div className="common-container">
                                ...
                                <button onClick={handleEye} className="relative w-[20px] h-[20px]   py-[10px] px-[10px]  overflow-hidden">
                                    <img
                            ...
                            {errorMessage && <p className='error-msg font-inter mt-[-15px]'>Password is not correct</p>}
                            ...
                            <div className={`common-container pt-[12px] pb-0 px-[16px]`}>
                                <div className="relative bg-inherit ">
                                    ...
                                    />
                                    <label htmlFor="username" className={`common-label font-inter left-0 -top-2 text-[12px] text-[#ECECEC] bg-inherit peer-placeholder-shown:text-[16px] peer-placeholder-shown:top-0 peer-focus:-top-2 peer-focus:text-[12px] peer-focus:h-[15px] transition-all`}>Date of birth</label>
                                </div>
                            </div>
                            {errorMessage && <p className='error-msg font-inter mt-[-15px] '>Invalid date</p>}
                ...
                {    successMessage &&
                 <div className='success-alert ml-[-1200px] mt-[617px]'>
                    ...
                    <p className='flex flex-col  justify-center  text-[20px] h-[24px] w-[308px] text-[#000] font-inter not-italic font-[500] leading-[119.523%] opacity-[0.8999999761581421]'>Welcome John Smith </p>
